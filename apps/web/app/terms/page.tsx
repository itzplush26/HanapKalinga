  ...
  return (
    <main className="px-5 py-8">
      <div className="mx-auto flex max-w-md flex-col gap-4 text-sm text-slate-700">
        ...
        <h2 className="text-base font-semibold text-slate-900">4. User Responsibilities</h2>
        ...
        <h2 className="text-base font-semibold text-slate-900">6. Prohibited Activities</h2>
        <p>Users may not:</p>
        <ul className="list-disc space-y-1 pl-5">
