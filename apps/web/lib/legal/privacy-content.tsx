  ...
  return (
    <div className="flex flex-col gap-4 text-sm text-text-secondary">
      <p className="text-xs text-text-muted">Last Updated: {PRIVACY_LAST_UPDATED}</p>
        ...
        <h2 className="text-base font-semibold text-text-primary">7. Third-Party Services</h2>
        <p>
        ...
        <h2 className="text-base font-semibold text-text-primary">8. Changes to This Policy</h2>
        <p>
