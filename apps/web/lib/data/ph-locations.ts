...
export const PH_REGION_CITIES: Record<PhRegion, string[]> = {
  ...
  "Region II - Cagayan Valley": ["Tuguegarao", "Ilagan", "Santiago", "Cauayan", "Bayombong", "Solano"],
  "Region III - Central Luzon": [
    "Angeles",
  ...
  "Region V - Bicol": ["Naga", "Legazpi", "Iriga", "Ligao", "Sorsogon City", "Tabaco", "Masbate City"],
  "Region VI - Western Visayas": [
    "Iloilo City",
    "Bacolod",
    "Roxas City",
  ...
  "Region VIII - Eastern Visayas": ["Tacloban", "Ormoc", "Calbayog", "Catbalogan", "Borongan", "Baybay"],
  "Region IX - Zamboanga Peninsula": [
    "Zamboanga City",
    "Pagadian",
    "Dipolog",
  ...
  "Region XI - Davao": ["Davao City", "Digos", "Tagum", "Panabo", "Mati", "Samal"],
  "Region XII - SOCCSKSARGEN": ["General Santos", "Koronadal", "Kidapawan", "Cotabato City", "Tacurong"],
...
export function getAllCities(): string[] {
  return Array.from(new Set(PH_REGIONS.flatMap((region) => PH_REGION_CITIES[region]))).sort((a, b) =>
    a.localeCompare(b)
  );
}
