...
- [x] 1. **Add new route entries to role layouts**
...
- [x] 3. **Checkpoint — Navigation exists**
...
- [x] 8. **Build Care Request detail screen**
...
- [x] 9. **Checkpoint — Family Care Requests complete**
...
- [x] 13. **Build Nurse Applications screen**
...
- [x] 14. **Checkpoint — Care Requests parity complete**
...
- [x] 15. **Extend `useBookingDetail` with action mutations**
...
- [x] 16. **Add Cancel button to Nurse booking detail**
...
- [x] 17. **Add Cancel button to Family booking detail**
  - Same pattern with family-specific reasons
  - _Requirements: 3.3, 3.4_

- [x] 18. **Add Mark Complete to Nurse booking detail**
...
- [x] 19. **Add Confirm/Dispute to Family booking detail**
...
- [x] 20. **Add `ReportUserMenu` to booking detail pages**
...
- [x] 21. **Checkpoint — Booking lifecycle complete**
...
- [x] 26. **Add Profile Photo Upload to Family & Nurse profile screens**
...
- [x] 27. **Add Theme Toggle to profile screens**
...
- [x] 28. **Checkpoint — Profile features complete**
